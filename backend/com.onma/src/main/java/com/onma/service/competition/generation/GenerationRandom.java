    ...
    private void generateTeam(final List<TeamModel> teams) {
        final TeamInformationModel teamInformationModel =
                TeamInformationModel.builder().
                        ...
                        transferBudget((long) random.nextInt(10000000)).
                        wageBudget((long) random.nextInt(1000000)).
                        build();
    ...
    private void generatePlayer(final Long number, final TeamModel teamModel) {
        final PlayerAttributesModel playerAttributesModel =
                PlayerAttributesModel.builder().
                        gk((long) random.nextInt(40) + 50).
                        def((long) random.nextInt(40) + 50).
                        mid((long) random.nextInt(40) + 50).
                        att((long) random.nextInt(40) + 50).
                        speed((long) random.nextInt(40) + 50).
                        physical((long) random.nextInt(40) + 50).
                        build();
        ...
        final PlayerModel playerModel =
                PlayerModel.builder().
                        ...
                        number(number).
                        estimatedPrice((long) random.nextInt(10000000)).
                        wage((long) random.nextInt(1000000)).
